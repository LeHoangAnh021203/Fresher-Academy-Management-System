...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240320044430_DB_LASTFIX_20032024")]
    partial class DBLASTFIX20032024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("760217a7-715f-4361-99e1-b839d28b55fb"),
                            CreateDate = new DateTime(2024, 3, 20, 11, 44, 30, 651, DateTimeKind.Local).AddTicks(3552),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 20, 11, 44, 30, 651, DateTimeKind.Local).AddTicks(3571),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("7720af52-24d5-49f9-8970-d237a06b554b"),
                            CreateDate = new DateTime(2024, 3, 20, 11, 44, 30, 651, DateTimeKind.Local).AddTicks(3589),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 3, 20, 11, 44, 30, 651, DateTimeKind.Local).AddTicks(3590),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("aab0cc73-1e9c-46e2-8072-8f48ae011412"),
                            CreateDate = new DateTime(2024, 3, 20, 11, 44, 30, 651, DateTimeKind.Local).AddTicks(3599),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 20, 11, 44, 30, 651, DateTimeKind.Local).AddTicks(3600),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
