...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240306065618_UpdateDB_AddTables_LocationandFsu_06032024")]
    partial class UpdateDBAddTablesLocationandFsu06032024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("70f87b26-c665-47fa-9f2a-1d00793f26c5"),
                            CreateDate = new DateTime(2024, 3, 6, 13, 56, 18, 177, DateTimeKind.Local).AddTicks(1389),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 6, 13, 56, 18, 177, DateTimeKind.Local).AddTicks(1397),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("9665d1b7-3fe5-460a-9cf5-14f8460b4f16"),
                            CreateDate = new DateTime(2024, 3, 6, 13, 56, 18, 177, DateTimeKind.Local).AddTicks(1410),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 3, 6, 13, 56, 18, 177, DateTimeKind.Local).AddTicks(1411),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("eab0568e-01dc-4598-92a7-85046223068e"),
                            CreateDate = new DateTime(2024, 3, 6, 13, 56, 18, 177, DateTimeKind.Local).AddTicks(1419),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 6, 13, 56, 18, 177, DateTimeKind.Local).AddTicks(1420),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
