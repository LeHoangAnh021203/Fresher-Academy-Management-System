...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240306093336_FixDB_Class_06032024")]
    partial class FixDBClass06032024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("48e5af83-0fa2-416b-b1b3-0ba8b23fb273"),
                            CreateDate = new DateTime(2024, 3, 6, 16, 33, 36, 101, DateTimeKind.Local).AddTicks(6631),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 6, 16, 33, 36, 101, DateTimeKind.Local).AddTicks(6647),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("f84ed805-7c80-492c-9fd9-a49b2d935107"),
                            CreateDate = new DateTime(2024, 3, 6, 16, 33, 36, 101, DateTimeKind.Local).AddTicks(6661),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 3, 6, 16, 33, 36, 101, DateTimeKind.Local).AddTicks(6661),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("6bfff941-77a0-476a-8bb4-858b7a75fbe8"),
                            CreateDate = new DateTime(2024, 3, 6, 16, 33, 36, 101, DateTimeKind.Local).AddTicks(6672),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 6, 16, 33, 36, 101, DateTimeKind.Local).AddTicks(6672),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
