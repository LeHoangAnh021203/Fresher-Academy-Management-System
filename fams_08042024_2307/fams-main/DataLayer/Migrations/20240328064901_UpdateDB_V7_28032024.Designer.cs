...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240328064901_UpdateDB_V7_28032024")]
    partial class UpdateDBV728032024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("71d74177-10dd-4840-ab7f-e9f8c660747e"),
                            CreateDate = new DateTime(2024, 3, 28, 13, 49, 0, 959, DateTimeKind.Local).AddTicks(7536),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 28, 13, 49, 0, 959, DateTimeKind.Local).AddTicks(7546),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("36c387c4-0151-4297-9ec0-eafc1a65918e"),
                            CreateDate = new DateTime(2024, 3, 28, 13, 49, 0, 959, DateTimeKind.Local).AddTicks(7563),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 3, 28, 13, 49, 0, 959, DateTimeKind.Local).AddTicks(7563),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("dd89dfad-4029-4374-a687-b15720fa7825"),
                            CreateDate = new DateTime(2024, 3, 28, 13, 49, 0, 959, DateTimeKind.Local).AddTicks(7574),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 28, 13, 49, 0, 959, DateTimeKind.Local).AddTicks(7575),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
