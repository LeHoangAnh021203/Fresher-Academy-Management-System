...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240130065304_UpdateTable_Syllabus_ChangeTypeModfCrt")]
    partial class UpdateTableSyllabusChangeTypeModfCrt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("128c6965-8b76-4801-a9ab-876166c6055d"),
                            CreateDate = new DateTime(2024, 1, 30, 13, 53, 3, 785, DateTimeKind.Local).AddTicks(3323),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 1, 30, 13, 53, 3, 785, DateTimeKind.Local).AddTicks(3334),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("9d5caf27-8bba-4af9-b1a3-f32e97929943"),
                            CreateDate = new DateTime(2024, 1, 30, 13, 53, 3, 785, DateTimeKind.Local).AddTicks(3346),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 1, 30, 13, 53, 3, 785, DateTimeKind.Local).AddTicks(3347),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("6e1ebef0-4174-4f18-bfde-02c98b8f2964"),
                            CreateDate = new DateTime(2024, 1, 30, 13, 53, 3, 785, DateTimeKind.Local).AddTicks(3356),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 1, 30, 13, 53, 3, 785, DateTimeKind.Local).AddTicks(3357),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
