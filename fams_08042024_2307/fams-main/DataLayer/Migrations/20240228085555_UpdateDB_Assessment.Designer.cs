...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240228085555_UpdateDB_Assessment")]
    partial class UpdateDBAssessment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("507636d7-7061-41cf-b321-47086784ba4d"),
                            CreateDate = new DateTime(2024, 2, 28, 15, 55, 55, 595, DateTimeKind.Local).AddTicks(3215),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 28, 15, 55, 55, 595, DateTimeKind.Local).AddTicks(3225),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("fec5f33a-a8ed-4b33-b97a-b7b75f94fa63"),
                            CreateDate = new DateTime(2024, 2, 28, 15, 55, 55, 595, DateTimeKind.Local).AddTicks(3238),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 2, 28, 15, 55, 55, 595, DateTimeKind.Local).AddTicks(3238),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("5b8d557a-5406-4d2d-adbd-58bfacbdab7b"),
                            CreateDate = new DateTime(2024, 2, 28, 15, 55, 55, 595, DateTimeKind.Local).AddTicks(3247),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 28, 15, 55, 55, 595, DateTimeKind.Local).AddTicks(3248),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
