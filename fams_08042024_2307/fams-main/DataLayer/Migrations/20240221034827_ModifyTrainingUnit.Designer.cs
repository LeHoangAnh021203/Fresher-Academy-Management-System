...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240221034827_ModifyTrainingUnit")]
    partial class ModifyTrainingUnit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("6e2d628d-ca66-46f3-8ab1-96b7db2518a7"),
                            CreateDate = new DateTime(2024, 2, 21, 10, 48, 27, 57, DateTimeKind.Local).AddTicks(803),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 21, 10, 48, 27, 57, DateTimeKind.Local).AddTicks(810),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("307baad9-77b0-4074-bc1c-7dac066e1d08"),
                            CreateDate = new DateTime(2024, 2, 21, 10, 48, 27, 57, DateTimeKind.Local).AddTicks(824),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 2, 21, 10, 48, 27, 57, DateTimeKind.Local).AddTicks(825),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("9dc18617-0fd2-44ac-b712-d91bac6a5db0"),
                            CreateDate = new DateTime(2024, 2, 21, 10, 48, 27, 57, DateTimeKind.Local).AddTicks(835),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 21, 10, 48, 27, 57, DateTimeKind.Local).AddTicks(835),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
