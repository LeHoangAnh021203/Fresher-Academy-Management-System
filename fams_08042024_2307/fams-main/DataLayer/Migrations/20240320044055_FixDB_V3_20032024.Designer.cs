...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240320044055_FixDB_V3_20032024")]
    partial class FixDBV320032024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("78f91215-4ffc-4897-9ce4-2064720c03a0"),
                            CreateDate = new DateTime(2024, 3, 20, 11, 40, 55, 618, DateTimeKind.Local).AddTicks(9403),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 20, 11, 40, 55, 618, DateTimeKind.Local).AddTicks(9419),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("1ed571d2-5b01-479d-ba12-e11bf66f225a"),
                            CreateDate = new DateTime(2024, 3, 20, 11, 40, 55, 618, DateTimeKind.Local).AddTicks(9433),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 3, 20, 11, 40, 55, 618, DateTimeKind.Local).AddTicks(9434),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("880e5358-9785-475d-91ce-0363a3a3d6f3"),
                            CreateDate = new DateTime(2024, 3, 20, 11, 40, 55, 618, DateTimeKind.Local).AddTicks(9443),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 20, 11, 40, 55, 618, DateTimeKind.Local).AddTicks(9443),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
