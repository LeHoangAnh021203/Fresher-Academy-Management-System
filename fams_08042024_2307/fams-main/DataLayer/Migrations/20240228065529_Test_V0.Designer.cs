...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240228065529_Test_V0")]
    partial class TestV0
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.Assessment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AssessmentID = "Java",
                            AssignmentCount = 3,
                            AssignmentPercent = 30.0,
                            FinalPracticePercent = 30.0,
                            FinalTheoryPercent = 20.0,
                            QuizCount = 2,
                            QuizPercent = 20
                        });
                });
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("a061d0fb-7fc1-4e48-be07-3d24a2f6c720"),
                            CreateDate = new DateTime(2024, 2, 28, 13, 55, 28, 833, DateTimeKind.Local).AddTicks(275),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 28, 13, 55, 28, 833, DateTimeKind.Local).AddTicks(284),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("9db22591-bf69-4b41-a067-d93bda263214"),
                            CreateDate = new DateTime(2024, 2, 28, 13, 55, 28, 833, DateTimeKind.Local).AddTicks(300),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 2, 28, 13, 55, 28, 833, DateTimeKind.Local).AddTicks(301),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("14cde510-371a-44e2-975b-fdebb087d6f0"),
                            CreateDate = new DateTime(2024, 2, 28, 13, 55, 28, 833, DateTimeKind.Local).AddTicks(309),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 28, 13, 55, 28, 833, DateTimeKind.Local).AddTicks(310),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
