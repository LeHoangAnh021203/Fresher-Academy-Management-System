...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240228043220_UpdateTable_Syllabus_28022024_1132")]
    partial class UpdateTableSyllabus280220241132
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("326962b0-d21b-4df2-96e3-64677295d4fd"),
                            CreateDate = new DateTime(2024, 2, 28, 11, 32, 20, 584, DateTimeKind.Local).AddTicks(9822),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 28, 11, 32, 20, 584, DateTimeKind.Local).AddTicks(9831),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("ba1903b1-47a2-485a-8b36-a85b3e1557fd"),
                            CreateDate = new DateTime(2024, 2, 28, 11, 32, 20, 584, DateTimeKind.Local).AddTicks(9844),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 2, 28, 11, 32, 20, 584, DateTimeKind.Local).AddTicks(9845),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("df1efe50-04c0-45ff-ace0-2e525df6c0f8"),
                            CreateDate = new DateTime(2024, 2, 28, 11, 32, 20, 584, DateTimeKind.Local).AddTicks(9856),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 28, 11, 32, 20, 584, DateTimeKind.Local).AddTicks(9857),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
