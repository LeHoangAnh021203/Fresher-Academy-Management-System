...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240320044350_FixDB_V4_20032024")]
    partial class FixDBV420032024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("9c082052-a13b-466c-95c2-bb51402194f1"),
                            CreateDate = new DateTime(2024, 3, 20, 11, 43, 49, 754, DateTimeKind.Local).AddTicks(1018),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 20, 11, 43, 49, 754, DateTimeKind.Local).AddTicks(1033),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("68505484-4d49-440d-b10e-3d0519b676a8"),
                            CreateDate = new DateTime(2024, 3, 20, 11, 43, 49, 754, DateTimeKind.Local).AddTicks(1048),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 3, 20, 11, 43, 49, 754, DateTimeKind.Local).AddTicks(1049),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("bb52b4e9-9898-4495-a7ee-61b5a795be55"),
                            CreateDate = new DateTime(2024, 3, 20, 11, 43, 49, 754, DateTimeKind.Local).AddTicks(1059),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 20, 11, 43, 49, 754, DateTimeKind.Local).AddTicks(1060),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
