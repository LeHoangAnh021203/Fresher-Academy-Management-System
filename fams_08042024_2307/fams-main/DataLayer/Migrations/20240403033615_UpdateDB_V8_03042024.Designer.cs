...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240403033615_UpdateDB_V8_03042024")]
    partial class UpdateDBV803042024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("f087053d-f29f-44d3-ba48-17e2b31f97e9"),
                            CreateDate = new DateTime(2024, 4, 3, 10, 36, 15, 384, DateTimeKind.Local).AddTicks(5186),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 4, 3, 10, 36, 15, 384, DateTimeKind.Local).AddTicks(5195),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("a1ec1999-1dc3-4c7e-bb98-0b9634f2e26f"),
                            CreateDate = new DateTime(2024, 4, 3, 10, 36, 15, 384, DateTimeKind.Local).AddTicks(5219),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 4, 3, 10, 36, 15, 384, DateTimeKind.Local).AddTicks(5219),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("b7447007-0d93-4d9d-aa39-651606e0fbac"),
                            CreateDate = new DateTime(2024, 4, 3, 10, 36, 15, 384, DateTimeKind.Local).AddTicks(5230),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 4, 3, 10, 36, 15, 384, DateTimeKind.Local).AddTicks(5230),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
