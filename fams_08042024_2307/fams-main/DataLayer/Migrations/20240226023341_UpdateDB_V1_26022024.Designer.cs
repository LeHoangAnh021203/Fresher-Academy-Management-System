...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240226023341_UpdateDB_V1_26022024")]
    partial class UpdateDBV126022024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("daca6e4a-cb9d-4a65-8bed-2cb5fa53a26e"),
                            CreateDate = new DateTime(2024, 2, 26, 9, 33, 41, 535, DateTimeKind.Local).AddTicks(3000),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 26, 9, 33, 41, 535, DateTimeKind.Local).AddTicks(3008),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("c17db5e2-fed2-45f6-ad07-26f1cf26a396"),
                            CreateDate = new DateTime(2024, 2, 26, 9, 33, 41, 535, DateTimeKind.Local).AddTicks(3065),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 2, 26, 9, 33, 41, 535, DateTimeKind.Local).AddTicks(3065),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("df251c2b-7ddc-42b9-8025-193aa860c899"),
                            CreateDate = new DateTime(2024, 2, 26, 9, 33, 41, 535, DateTimeKind.Local).AddTicks(3075),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 26, 9, 33, 41, 535, DateTimeKind.Local).AddTicks(3076),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
