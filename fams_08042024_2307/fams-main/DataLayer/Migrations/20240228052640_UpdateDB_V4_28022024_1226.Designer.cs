...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240228052640_UpdateDB_V4_28022024_1226")]
    partial class UpdateDBV4280220241226
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("fd006e94-81e3-4c96-8198-9e1a52bba517"),
                            CreateDate = new DateTime(2024, 2, 28, 12, 26, 40, 565, DateTimeKind.Local).AddTicks(35),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 28, 12, 26, 40, 565, DateTimeKind.Local).AddTicks(45),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("57c005a0-b5ca-4d9a-87e8-836595f028b6"),
                            CreateDate = new DateTime(2024, 2, 28, 12, 26, 40, 565, DateTimeKind.Local).AddTicks(58),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 2, 28, 12, 26, 40, 565, DateTimeKind.Local).AddTicks(59),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("af8acd56-2618-4fb3-8e0a-7bc8188e56bf"),
                            CreateDate = new DateTime(2024, 2, 28, 12, 26, 40, 565, DateTimeKind.Local).AddTicks(69),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 28, 12, 26, 40, 565, DateTimeKind.Local).AddTicks(70),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
