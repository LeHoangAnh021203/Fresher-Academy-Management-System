...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240130065550_NothingChange")]
    partial class NothingChange
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("bb2d4e22-0576-4be3-a10e-042b75c925d8"),
                            CreateDate = new DateTime(2024, 1, 30, 13, 55, 50, 571, DateTimeKind.Local).AddTicks(2732),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 1, 30, 13, 55, 50, 571, DateTimeKind.Local).AddTicks(2750),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("98a17d50-a0be-4a71-bb43-aabf5c491fd1"),
                            CreateDate = new DateTime(2024, 1, 30, 13, 55, 50, 571, DateTimeKind.Local).AddTicks(2770),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 1, 30, 13, 55, 50, 571, DateTimeKind.Local).AddTicks(2771),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("0a2e60bc-a801-42b0-8b68-9ed53d284af7"),
                            CreateDate = new DateTime(2024, 1, 30, 13, 55, 50, 571, DateTimeKind.Local).AddTicks(2781),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 1, 30, 13, 55, 50, 571, DateTimeKind.Local).AddTicks(2781),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
