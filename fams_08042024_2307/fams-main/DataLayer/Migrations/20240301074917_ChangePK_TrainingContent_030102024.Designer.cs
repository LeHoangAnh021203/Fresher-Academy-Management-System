...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240301074917_ChangePK_TrainingContent_030102024")]
    partial class ChangePKTrainingContent030102024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("2a638fb0-d2a1-4f82-ab34-a6baed2fa69a"),
                            CreateDate = new DateTime(2024, 3, 1, 14, 49, 16, 805, DateTimeKind.Local).AddTicks(4253),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 1, 14, 49, 16, 805, DateTimeKind.Local).AddTicks(4265),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("0996d074-d8d7-49cf-af0a-73e4e9e1aee2"),
                            CreateDate = new DateTime(2024, 3, 1, 14, 49, 16, 805, DateTimeKind.Local).AddTicks(4275),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 3, 1, 14, 49, 16, 805, DateTimeKind.Local).AddTicks(4275),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("52bee380-a77f-42b4-8651-5be375f9a056"),
                            CreateDate = new DateTime(2024, 3, 1, 14, 49, 16, 805, DateTimeKind.Local).AddTicks(4281),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 1, 14, 49, 16, 805, DateTimeKind.Local).AddTicks(4281),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
