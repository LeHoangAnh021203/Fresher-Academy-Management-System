...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240403062959_UpdateDB_V9_03042024")]
    partial class UpdateDBV903042024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("874d0d28-f8ef-4030-8d9f-ed00464513ab"),
                            CreateDate = new DateTime(2024, 4, 3, 13, 29, 59, 150, DateTimeKind.Local).AddTicks(9822),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 4, 3, 13, 29, 59, 150, DateTimeKind.Local).AddTicks(9834),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("be216f85-08d3-4cf6-a652-cee493adba73"),
                            CreateDate = new DateTime(2024, 4, 3, 13, 29, 59, 150, DateTimeKind.Local).AddTicks(9852),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 4, 3, 13, 29, 59, 150, DateTimeKind.Local).AddTicks(9852),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("68d986b6-40a7-4840-8a84-4e605df56b3e"),
                            CreateDate = new DateTime(2024, 4, 3, 13, 29, 59, 150, DateTimeKind.Local).AddTicks(9863),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 4, 3, 13, 29, 59, 150, DateTimeKind.Local).AddTicks(9864),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
