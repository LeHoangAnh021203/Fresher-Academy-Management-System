...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240221035040_ModifyTrainingUnit_V1")]
    partial class ModifyTrainingUnitV1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("533b3c28-f302-4c86-a252-1ed7e427c218"),
                            CreateDate = new DateTime(2024, 2, 21, 10, 50, 40, 442, DateTimeKind.Local).AddTicks(9226),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 21, 10, 50, 40, 442, DateTimeKind.Local).AddTicks(9236),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("0a7ddb12-ff95-4c85-bbe4-f1b583f2bf52"),
                            CreateDate = new DateTime(2024, 2, 21, 10, 50, 40, 442, DateTimeKind.Local).AddTicks(9249),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 2, 21, 10, 50, 40, 442, DateTimeKind.Local).AddTicks(9250),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("209bac26-fbc3-486f-9f7f-96cf4246990c"),
                            CreateDate = new DateTime(2024, 2, 21, 10, 50, 40, 442, DateTimeKind.Local).AddTicks(9259),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 21, 10, 50, 40, 442, DateTimeKind.Local).AddTicks(9259),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
