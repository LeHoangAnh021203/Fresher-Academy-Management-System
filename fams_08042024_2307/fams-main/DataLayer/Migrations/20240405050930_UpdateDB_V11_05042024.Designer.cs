...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240405050930_UpdateDB_V11_05042024")]
    partial class UpdateDBV1105042024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("a4dad951-2124-4d8b-a563-35597d689fcb"),
                            CreateDate = new DateTime(2024, 4, 5, 12, 9, 30, 361, DateTimeKind.Local).AddTicks(2145),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 4, 5, 12, 9, 30, 361, DateTimeKind.Local).AddTicks(2152),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("5aee82c6-25a5-4361-8b4c-635a1a121ce7"),
                            CreateDate = new DateTime(2024, 4, 5, 12, 9, 30, 361, DateTimeKind.Local).AddTicks(2162),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 4, 5, 12, 9, 30, 361, DateTimeKind.Local).AddTicks(2163),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("067db6be-b9b1-4893-a192-cf7f8ff2fcd4"),
                            CreateDate = new DateTime(2024, 4, 5, 12, 9, 30, 361, DateTimeKind.Local).AddTicks(2177),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 4, 5, 12, 9, 30, 361, DateTimeKind.Local).AddTicks(2177),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
