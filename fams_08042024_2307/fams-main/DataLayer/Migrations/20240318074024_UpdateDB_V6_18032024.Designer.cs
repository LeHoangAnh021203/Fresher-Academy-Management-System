...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240318074024_UpdateDB_V6_18032024")]
    partial class UpdateDBV618032024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("6157b81b-49b4-4add-a930-824fb641e3cc"),
                            CreateDate = new DateTime(2024, 3, 18, 14, 40, 24, 619, DateTimeKind.Local).AddTicks(9997),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 18, 14, 40, 24, 620, DateTimeKind.Local).AddTicks(6),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("32ef3d52-1169-4079-9fbd-6ed699148c32"),
                            CreateDate = new DateTime(2024, 3, 18, 14, 40, 24, 620, DateTimeKind.Local).AddTicks(21),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 3, 18, 14, 40, 24, 620, DateTimeKind.Local).AddTicks(22),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("08fbca18-1e2f-4733-88a1-f8bcd3405815"),
                            CreateDate = new DateTime(2024, 3, 18, 14, 40, 24, 620, DateTimeKind.Local).AddTicks(31),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 18, 14, 40, 24, 620, DateTimeKind.Local).AddTicks(32),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
