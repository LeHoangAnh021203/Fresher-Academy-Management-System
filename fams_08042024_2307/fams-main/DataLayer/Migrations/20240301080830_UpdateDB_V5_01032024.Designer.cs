...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240301080830_UpdateDB_V5_01032024")]
    partial class UpdateDBV501032024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("a9bde18c-f82c-452c-a0e8-5d862b2a1ec3"),
                            CreateDate = new DateTime(2024, 3, 1, 15, 8, 30, 160, DateTimeKind.Local).AddTicks(4107),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 1, 15, 8, 30, 160, DateTimeKind.Local).AddTicks(4115),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("c3f677ad-638e-43bb-ac0a-0bcdb97ed0da"),
                            CreateDate = new DateTime(2024, 3, 1, 15, 8, 30, 160, DateTimeKind.Local).AddTicks(4124),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 3, 1, 15, 8, 30, 160, DateTimeKind.Local).AddTicks(4124),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("7e1d7921-9162-42c6-b6b5-b4ad3fdedc96"),
                            CreateDate = new DateTime(2024, 3, 1, 15, 8, 30, 160, DateTimeKind.Local).AddTicks(4130),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 3, 1, 15, 8, 30, 160, DateTimeKind.Local).AddTicks(4130),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
