...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240226052507_UpdateDB_V3_26022024_1225")]
    partial class UpdateDBV3260220241225
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("51e5d305-4322-44f2-9989-dac1206924e7"),
                            CreateDate = new DateTime(2024, 2, 26, 12, 25, 6, 935, DateTimeKind.Local).AddTicks(5636),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 26, 12, 25, 6, 935, DateTimeKind.Local).AddTicks(5645),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("6384f22b-9a49-456a-8716-a63d500086b7"),
                            CreateDate = new DateTime(2024, 2, 26, 12, 25, 6, 935, DateTimeKind.Local).AddTicks(5659),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 2, 26, 12, 25, 6, 935, DateTimeKind.Local).AddTicks(5659),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("a6f1d28b-9f14-4aeb-a27b-b2784c943487"),
                            CreateDate = new DateTime(2024, 2, 26, 12, 25, 6, 935, DateTimeKind.Local).AddTicks(5678),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 26, 12, 25, 6, 935, DateTimeKind.Local).AddTicks(5679),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
