...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240226052211_UpdateDB_V2_26022024_1220")]
    partial class UpdateDBV2260220241220
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("2f42e333-2630-49b0-87da-650d3640c827"),
                            CreateDate = new DateTime(2024, 2, 26, 12, 22, 11, 385, DateTimeKind.Local).AddTicks(4235),
                            DOB = new DateTime(2000, 2, 27, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "superadmin@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 26, 12, 22, 11, 385, DateTimeKind.Local).AddTicks(4244),
                            Name = "Super Admin",
                            Password = "123@",
                            PermissionId = 1,
                            Phone = "0987788762",
                        ...
                        new
                        {
                            UserId = new Guid("37296286-89f4-4433-806a-79c55e5bd3ec"),
                            CreateDate = new DateTime(2024, 2, 26, 12, 22, 11, 385, DateTimeKind.Local).AddTicks(4258),
                            DOB = new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@gmail.com",
                            Gender = 2,
                            ModifiedTime = new DateTime(2024, 2, 26, 12, 22, 11, 385, DateTimeKind.Local).AddTicks(4259),
                            Name = "Admin",
                            Password = "123@",
                            PermissionId = 2,
                            Phone = "0955422567",
                        ...
                        new
                        {
                            UserId = new Guid("b614fe59-0d98-463e-9dc1-7258a9ba159e"),
                            CreateDate = new DateTime(2024, 2, 26, 12, 22, 11, 385, DateTimeKind.Local).AddTicks(4277),
                            DOB = new DateTime(2003, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "trainer1@gmail.com",
                            Gender = 1,
                            ModifiedTime = new DateTime(2024, 2, 26, 12, 22, 11, 385, DateTimeKind.Local).AddTicks(4278),
                            Name = "Trainer1",
                            Password = "123@",
                            PermissionId = 3,
                            Phone = "0876588765",
